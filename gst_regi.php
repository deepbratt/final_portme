<?php
	...
	if(isset($_POST['register-submit']))
	{
		...
		$get_efileing_leeds = mysqli_query($mysqli,"insert into gst_regi_leeds values('','".$name."','".$email."','".$enterprise_name."','".$phone."')");
...
<head>
    ...
    <body>
		...
		<section class="demo-request ">
			<div class="whtscoch" id="whtscoch">
				<div class="container">
				  ...
				  <p style="margin-top:45px;">Request For GST Registration id Process</p>
				</div>
			</div>
		</section>
        <!-- ==============================================
		...
		<section class="contact ptb-80">
			...
			?>
				<p style="text-align:left;background:#5cb85c;border:1px solid #CCC;border-radius:5px;padding:5px;color:#fff;font-weight:bold;"> You Have Successfully Request For GST Registration,Our Exicutive Will Call You In An Hour!! </p>
			<?php
			...
			<div class="row main">
				<div class="col-md-8 main-login main-center" >
					<div style="height:45px;border:1px solid red;background:#f73347">
						<p style="text-align:center;font-size:18px;color:white;">Request For GST Registration</p>
					</div>
