		...
		<div class="col-md-8 col-md-offset-2"  style="margin-top:13%;">
			...
			<div class="col-md-3 col-sm-3 col-xs-3">
			  <div class="iconbox-center  headShake">
				...
				<h5 style="margin-top:10px; color:#232321;">INVOIVING
				</h5>
				<p>
				</p>
				<div class="clear" ></div>
            ...
            <div class="tab-content service-1" style="margin-top:0px;">
                <div id="menu1" class="tab-pane fade in active">
                  <div class="col-md-4" style="">
                    <div style="border:2px solid #981c34; margin-top:60px; height:300px; width:100%; float:left; background:#ececec; border-radius:20px;">
                    ...
                    <h6 style="font-size:18px; text-align:center;padding-top:50px;  font-weight:500;">BILLING SOFTWARE WITH GST.</h6>
					...
					<a href="signup.php?plan=1"><button class="waves-effect btn brochure-btn1 mobile-btn" style="top:340px; margin-left:120px; background:#e52d2d; text-align:center; float:left; font-size:16px; font-weight:500; position:absolute;">View More</button></a>
                  </div>
                  ...
                  <div class="col-md-4">
                    <div style="border:2px solid #981c34; margin-top:60px; height:300px; width:100%; float:left; background:#ececec; border-radius:20px;">
                    <center><img src="images/Rupee-Symbol-PNG-Transparent-Image.png" width="20%" style="position:absolute; margin-top:-90px; margin-left:-40px; "/></center>
						<h6 style="font-size:18px; text-align:center;padding-top:50px;  font-weight:500;">GST SOFTWARE AND SUPPORT</h6>
						<span style="margin-left:165px;"><i class="fa fa-plus fa-2" style="font-color:#f73347;" aria-hidden="true"></i></span>
                    ...
                    <a href="signup.php?plan=2"><button class="waves-effect btn brochure-btn1 mobile-btn" style="top:340px; margin-left:120px; background:#e52d2d; text-align:center; float:left; font-size:16px; font-weight:500; position:absolute;">View More</button></a>
                  </div>
                  ...
                  <div class="col-md-4">
                    ...
                    <a href="signup.php?plan=3"><button class="waves-effect btn brochure-btn1 mobile-btn" style="top:340px; margin-left:120px; background:#e52d2d; text-align:center; float:left; font-size:16px; font-weight:500; position:absolute;">View More</button></a>
                  </div>
